...
import { Group, Mesh, InstancedMesh, PlaneGeometry, BoxGeometry, MeshBasicMaterial, Object3D, DoubleSide, AdditiveBlending, Color, RepeatWrapping, SRGBColorSpace } from 'three'
...
export async function createBar(
  props: CityBarProps,
  callback?: (barHeight: number) => void
): Promise<Group | null> {
  try {
    const {
      position = [0, 0, 0],
